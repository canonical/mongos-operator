...
async def test_mongos_tls_enabled(ops_test: OpsTest) -> None:
    ...
    await tls_helpers.check_mongos_tls_enabled(ops_test)
...
async def test_mongos_tls_disabled(ops_test: OpsTest) -> None:
    ...
    await tls_helpers.toggle_tls_mongos(ops_test, enable=False)
    await tls_helpers.check_mongos_tls_disabled(ops_test)
...
async def test_tls_reenabled(ops_test: OpsTest) -> None:
    ...
    await tls_helpers.toggle_tls_mongos(ops_test, enable=True)
    await tls_helpers.check_mongos_tls_enabled(ops_test)
