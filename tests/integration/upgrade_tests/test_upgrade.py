...
async def test_build_and_deploy(ops_test: OpsTest) -> None:
    ...
    # TODO: deploy using new_charm - use the one deployed on charmhub - cannot do this until
    # upgrades "land" on charmhub
...
@pytest.mark.group(1)
@pytest.mark.abort_on_fail
async def test_upgdade(ops_test: OpsTest) -> None:
